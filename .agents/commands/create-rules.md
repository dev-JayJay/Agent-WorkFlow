...
Create a universal AGENT.md file that serves as the primary instruction document for any AI coding agent.

The generated document should enable an AI agent to quickly understand:
...
This document should remain vendor-neutral and reusable across different AI coding assistants.
