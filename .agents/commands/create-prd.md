...
Generate a comprehensive Product Requirements Document (PRD) based on the current conversation context that serves as the single source of truth for the product and requirements discussed. Use the structure and sections defined below to create a thorough, professional PRD.

The generated PRD should define:
...
The PRD should be implementation-agnostic and should not contain implementation code.
